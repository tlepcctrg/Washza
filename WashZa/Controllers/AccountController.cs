...
namespace WashZa.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            AspNetUser db = new AspNetUser();
            WashzaEntities1 dbd = new WashzaEntities1();
            return View(dbd.AspNetUsers.ToList());
        }
        //
        // POST: /Account/Login
        [HttpPost]
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
         ...
         //           smtp.Credentials = new System.Net.NetworkCredential("adminitrator@firstvmtle.southeastasia.cloudapp.azure.com", "password@1234");\
         //           smtp.EnableSsl = true;
         //           smtp.Send(m);
